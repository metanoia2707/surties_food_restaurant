...
ThemeData dark = ThemeData(
  ...
  colorScheme: const ColorScheme.dark(primary: Color(0xFFFFC300), secondary: Color(0xFFFFC300)).copyWith(error: const Color(0xFFdd3135), tertiary: const Color(0xFF334257)),
