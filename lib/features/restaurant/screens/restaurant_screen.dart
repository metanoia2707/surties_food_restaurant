...
import 'package:surties_food_restaurant/features/restaurant/widgets/filter_data_bottom_sheet.dart';
import 'package:surties_food_restaurant/features/profile/domain/models/profile_model.dart';
import 'package:surties_food_restaurant/features/restaurant/widgets/product_view_widget.dart';
                                ...
                                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                  Text(
                                   index == 0 ? 'all'.tr : restController.categoryNameList![index],
                                    style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, fontWeight: index == restController.categoryIndex ? FontWeight.w700 : FontWeight.w400),
                                  ),
                                ]),
                              ),
                            );
