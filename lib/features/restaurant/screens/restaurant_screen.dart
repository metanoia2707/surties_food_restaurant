...
import 'package:surties_food_restaurant/features/restaurant/widgets/veg_filter_widget.dart';
          ...
          floatingActionButton:
            ...
            return restaurantController.isFabVisible
                ? Column(mainAxisAlignment: MainAxisAlignment.end, children: [
                    InkWell(
                      onTap: () => Get.toNamed(RouteHelper.getAnnouncementRoute(
                          announcementStatus: restaurant!.isAnnouncementActive!,
                          announcementMessage:
