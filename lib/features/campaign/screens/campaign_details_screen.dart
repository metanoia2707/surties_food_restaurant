...
import 'package:surties_food_restaurant/features/campaign/widgets/join_campaign_bottom_sheet_widget.dart';
      ...
      body: Column(children: [
        Expanded(
          child: Padding(
            ...
            child:
                                  ...
                                  child: Column(children: [
                                    Text(
                                      DateConverter.stringToLocalDateDayOnly(
                                          campaignModel.availableDateEnds!),
              ...
              SizedBox(
                  height: campaignModel.isJoined!
                      ? Dimensions.paddingSizeLarge
                      : 0),
              campaignModel.isJoined!
                  ? Row(children: [
        ...
        Container(
          ...
          child: CustomButtonWidget(
            buttonText:
                campaignModel.isJoined! ? 'leave_now'.tr : 'join_now'.tr,
            color: campaignModel.isJoined!
                ? Theme.of(context).disabledColor.withOpacity(0.5)
                : Theme.of(context).primaryColor,
            textColor: campaignModel.isJoined!
