                              ...
                              ? InkWell(
                                  ...
                                  child: Row(children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: orderController.campaignOnly
                                            ? Colors.green
                                    ...
                                    Text(
                                      'campaign_order'.tr,
                                      style: orderController.campaignOnly
                              ...
                              ? InkWell(
                                  ...
                                  child: Row(children: [
                                    Container(
                                      ...
                                      margin: const EdgeInsets.only(
                                          right:
                                              Dimensions.paddingSizeExtraSmall),
                                      decoration: BoxDecoration(
                                        color: orderController.subscriptionOnly
                                            ? Colors.green
                                            : Theme.of(context).cardColor,
                                        border: Border.all(
                                            color:
                                                orderController.subscriptionOnly
                                                    ? Colors.transparent
                                                    : Theme.of(context)
                                                        .disabledColor),
                                        shape: BoxShape.circle,
                                    ...
                                    Text(
                                      ...
                                      style: orderController.subscriptionOnly
                                          ? robotoMedium.copyWith(
                                              color: Theme.of(context)
                                                  .textTheme
                                                  .bodyMedium!
