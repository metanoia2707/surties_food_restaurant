...
import 'package:surties_food_restaurant/common/widgets/input_dialog_widget.dart';
...
import 'package:surties_food_restaurant/features/order/widgets/pdf_generate_dialog.dart';
import 'package:surties_food_restaurant/features/order/widgets/section_widget.dart';
...
import 'package:surties_food_restaurant/features/order/domain/models/order_details_model.dart';
import 'package:surties_food_restaurant/features/order/domain/models/order_model.dart';
import 'package:surties_food_restaurant/features/order/screens/invoice_print_screen.dart';
import 'package:surties_food_restaurant/features/order/widgets/available_deliveryman_bottom_sheet_widget.dart';
import 'package:surties_food_restaurant/features/order/widgets/camera_button_sheet_widget.dart';
import 'package:surties_food_restaurant/features/order/widgets/cancellation_dialogue_widget.dart';
import 'package:surties_food_restaurant/features/order/widgets/collect_money_delivery_sheet_widget.dart';
import 'package:surties_food_restaurant/features/order/widgets/dialogue_image_widget.dart';
import 'package:surties_food_restaurant/features/order/widgets/order_product_widget.dart';
import 'package:surties_food_restaurant/features/order/widgets/slider_button_widget.dart';
import 'package:surties_food_restaurant/features/order/widgets/verify_delivery_sheet_widget.dart';
    ...
    return GetBuilder<OrderController>(builder: (orderController) {
      ...
      bool showSlider = controllerOrderModel != null
          ? ((controllerOrderModel.orderStatus ==
                      'pending' /*|| controllerOrderModel.orderStatus == 'accepted'*/) &&
        ...
        child: Scaffold(
          appBar: CustomAppBarWidget(
            ...
            subTitle: order != null && widget.orderModel.orderStatus != null
                ? '${'order_is'.tr} ${controllerOrderModel?.orderStatus?.tr ?? widget.orderModel.orderStatus!.tr}'
                : null,
            menuWidget: InkWell(
              onTap: () {
                Get.dialog(Dialog(
